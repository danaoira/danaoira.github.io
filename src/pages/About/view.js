      ...
      <Grid2Col>
        <Section className={'about'}>
          ...
          <Paragraph>
            ...
            days of dial-up, <Link href={links.dhtml}>DHTML</Link> and life
            before social networks existed - it was a magical, neverending
            frontier.
          </Paragraph>
          <Paragraph>
            While discovering my career path, I studied Public Health where I
            used <Link href={links.r}>R</Link> to visualize{' '}
            <Link href={links.epidemiology}>epidemiology</Link> and statistics.
            I took <Link href={links.hci}>Human Computer Interaction</Link> on a
          ...
          <Paragraph>
            After all the code I wrote, I realized that the common denominator
            was creating data visualizations.
          </Paragraph>
          <Paragraph>
            ...
            transforming them into beautiful and functional data visualizations.
            I would love to work with Public Health or Epidemiology data,
            especially if Machine Learning and AI are involved.
          </Paragraph>
          <Paragraph>
            Please reach out to me on{' '}
            <Link href={links.linkedin}>LinkedIn</Link> if you're interested in
            hiring me!
          </Paragraph>
        </Section>
